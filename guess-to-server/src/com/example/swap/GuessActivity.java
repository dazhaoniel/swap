...
public class GuessActivity extends Activity {
	...
	private class GuessTask extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			 ...
			 * catch (Exception e) { Log.i(LOGTAG, "Error converting result " +
			 * e.toString()); }
			 */
			// paring data
			 ...
			 *******************************************************************/
			/*
			 * String[] temp = new String[5]; String[] humid = new String[5];
			 * String[] noaa_station = new String[5]; String[] noaa_distance =
			 * new String[5]; String[] noaa_temp = new String[5]; String[]
			 * noaa_humid = new String[5];
			 */
			/***********************************************************************/

			/*
			 * 
			 * try{ jArray = new JSONArray(result); JSONObject json_data=null;
			 * //output = json_data.getString("user_id");
			 * 
			 * for(int i=0;i<jArray.length();i++){ json_data =
			 * jArray.getJSONObject(i); temp[i]=json_data.getString("temp");
			 ...
			 */
			/*
			 * Toast.makeText(getBaseContext(), noaa_distance[0]
			 ...
			 */
			/*
			 * } catch(JSONException e1){ Toast.makeText(getBaseContext(),
